		...
		*/
        ...
        void Hit()
        {
            ...
            { // The hit object has "Damage_Control_CS".
                ...
                if (targetDamageScript.Get_Damage(damageValue) == true)
                { // The target is destroyed.

                    // Call "Score_Manager_CS" in the scene to update the 'Kills' score.
                    if (spawnerScript && Score_Manager_CS.instance)
                    {
                        Score_Manager_CS.instance.Update_Kills_Count(spawnerScript);
                    }
                }
            }
