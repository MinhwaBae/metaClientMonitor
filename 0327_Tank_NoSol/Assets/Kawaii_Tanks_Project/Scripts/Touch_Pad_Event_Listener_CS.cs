...
namespace ChobiAssets.KTP
{
    ...
    public class Touch_Pad_Event_Listener_CS : MonoBehaviour
    {
        ...
        // Auto Lock button.
        public void AutoLockButtonDown(BaseEventData eventData)
        {
            Key_Bindings_CS.IsAutoLockButtonPressing = true;
            var pointerEventData = eventData as PointerEventData;
            Key_Bindings_CS.AutoLockButtonDownPosition = pointerEventData.position;
        }
        public void AutoLockButtonUp(BaseEventData eventData)
        {
            Key_Bindings_CS.IsAutoLockButtonPressing = false;
            var pointerEventData = eventData as PointerEventData;
            Key_Bindings_CS.AutoLockButtonUpPosition = pointerEventData.position;
        }
